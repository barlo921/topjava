...
public class HsqlDbJdbcMealRepository extends AbstractJdbcMealRepository {
    ...
    @Autowired
    protected HsqlDbJdbcMealRepository(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    protected MapSqlParameterSource getMap(Meal meal, int userId) {
        Date date = Timestamp.valueOf(meal.getDateTime());
