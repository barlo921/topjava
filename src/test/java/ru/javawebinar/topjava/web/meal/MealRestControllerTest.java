...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void testDelete() throws Exception {
        ...
        List<Meal> meals = new ArrayList<Meal>(MEALS);
        meals.remove(MEAL1);
    ...
    void testCreate() throws Exception {
        Meal expected = new Meal(null, LocalDateTime.now(), "Breakfast", 1000);
    ...
    void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?start=" + MEAL1.getDateTime() + "&end=" + MEAL4.getDateTime()))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(contentJson(MEAL4, MEAL3, MEAL2, MEAL1));
    }
}