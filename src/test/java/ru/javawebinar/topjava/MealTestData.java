...
import static ru.javawebinar.topjava.util.MealsUtil.getWithoutExcess;
...
public class MealTestData {
    ...
    public static ResultMatcher contentJson(Meal ... expected) {
        return result -> assertMatch(getWithoutExcess(readListFromJsonMvcResult(result, MealTo.class)), List.of(expected));
    }
